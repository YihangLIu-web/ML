...
def configure_device():
    """Configure compute device with priority: MPS > CUDA > CPU"""
...
class GCNPredictor(nn.Module):
    ...
    def __init__(self, node_dim=11, hidden_dim=128, output_dim=1, dropout=0.3):
        super().__init__()
    ...
    def forward(self, data):
        ...
        Args:
            data (Data): PyG Data object with x, edge_index, batch

        Returns:
            torch.Tensor: Predicted property values
        """
